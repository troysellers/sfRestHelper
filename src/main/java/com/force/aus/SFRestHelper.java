...
public class SFRestHelper {
	...
	public OAuthResult login(OAuthProperties props, boolean getIdentity) throws JSONException, IOException {
		...
		params.put("password", props.getPassword()+props.getSecurityToken());
	...
	public QueryResult runQuery(OAuthResult oAuth, String query, String apiVersion) throws JSONException {
		...
		doGet(oAuth.getIdentity().getURL("query", apiVersion), client, params, result, oAuth);
		try {
			client.close();
